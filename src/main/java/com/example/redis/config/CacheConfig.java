...
/**
 * Cache configuration with domain-specific TTLs.
 * Implements CachingConfigurer for custom error handling.
 */
@Configuration
public class CacheConfig implements CachingConfigurer {
    ...
    public CacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        ...
        cacheConfigurations.put(CACHE_REFERENCE_DATA, defaultConfig.entryTtl(Duration.ofSeconds(referenceDataTtl)));
